...
// import {AsciiEffectPostNode} from '..
import { AsciiEffectPostNode } from "../PolyConfig";
// rop
...
export class PolySceneWithNodeMap_scene_01 extends PolyScene {
  ...
  override node(
    path: "/cameras/cameraPostProcess1/asciiEffect1"
  ): AsciiEffectPostNode;
...
export interface PolySceneProps_scene_01 {
  ...
  "cameras-cameraPostProcess1-asciiEffect1--resolution"?: ParamValueSerializedTypeMap["vector2"];
  "cameras-cameraPostProcess1-asciiEffect1--resolution-resolutionx"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-asciiEffect1--resolution-resolutiony"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-asciiEffect1--resolutionx"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-asciiEffect1--resolutiony"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-asciiEffect1--color"?: ParamValueSerializedTypeMap["boolean"];
  "cameras-cameraPostProcess1-asciiEffect1--background"?: ParamValueSerializedTypeMap["boolean"];
  "cameras-cameraPostProcess1-asciiEffect1--charset"?: ParamValueSerializedTypeMap["string"];
  "cameras-cameraPostProcess1-asciiEffect1--textColor"?: ParamValueSerializedTypeMap["color"];
  "cameras-cameraPostProcess1-asciiEffect1--textColor-textColorr"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-asciiEffect1--textColor-textColorg"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-asciiEffect1--textColor-textColorb"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-asciiEffect1--textColorr"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-asciiEffect1--textColorg"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-asciiEffect1--textColorb"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-asciiEffect1--fontSize"?: ParamValueSerializedTypeMap["float"];
